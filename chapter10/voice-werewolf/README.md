...
## 真实运行样例（`python demo.py`，seed=42，gpt-4o-mini）

夜晚（私密行动，均带可见范围标注）：

```
【第 1 回合 · 夜晚】天黑请闭眼。
  [仅法官+狼人可见] 狼人 P1 提议击杀 → P4
  [仅法官+狼人可见] 狼人 P6 提议击杀 → P4
  → 狼人共识：击杀 P4（此共识只进狼人上下文）
  [仅法官+预言家 P4 可见] 预言家查验 P3 → 好人
  [仅法官+女巫 P2 可见] 女巫得知今晚被刀者：P4
  [仅法官+女巫可见] 女巫使用解药救 P4
```

白天投票放逐 → 结算，好人阵营在第 2 回合放逐最后一只狼人后获胜。
...
对照可见：狼人 P1 的上下文里有「狼人阵营的玩家是：P1、P6」和「狼人决定击杀 …」，
而村民 P3 的上下文里**没有任何他人身份**、预言家 P4 的上下文里**独有**「查验 …
结果为 …」。这就是信息权限控制生效的直接证据。
